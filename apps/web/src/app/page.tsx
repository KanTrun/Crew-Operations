...
export default function HomePage() {
  ...
  return (
    <main className="relative min-h-dvh bg-[var(--nq-bg)]">
      ...
      <section className="relative z-10 flex min-h-dvh flex-col items-center justify-center px-4 py-16">
        <div className="mx-auto flex w-full max-w-4xl flex-col items-center text-center">
          ...
          <div className="mb-8 flex flex-wrap justify-center gap-x-4 gap-y-2 text-5xl font-black leading-[0.9] tracking-tighter text-[var(--nq-fg)] uppercase sm:text-7xl md:text-8xl">
            <span className="block">NHỊP</span>
            <span className="block text-[var(--nq-copper)]">QUÁN</span>
          </div>

          <p className="mb-10 max-w-2xl text-lg font-medium text-[var(--nq-dim)] md:text-2xl">
