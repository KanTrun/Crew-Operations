...
def run_predict(
    ...
    # Lưu vào KV store — khử trùng theo pattern_id/rule_id: chạy lại cùng dữ
    # liệu không được tích lũy bản sao (trước đây prepend mù → 21 "mẫu" trong
    # khi chỉ có 3 mẫu khác nhau; sửa 2026-09-26).
