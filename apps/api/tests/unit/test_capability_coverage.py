...
EXCLUDED_ROUTES: dict[str, str] = {
    ...
    "/api/v1/phieu/current": "R0: nhiệm vụ phiếu tất định qua UI /phieu",
    "/api/v1/phieu/resolve": "R2: tạo idempotent phiếu đã được core policy cấp quyền",
    "/api/v1/lich-tuan/phu-trach": "R3: quản lý gán phụ trách qua UI /lich-tuan",
